...
if( ! function_exists( 'basel_sguide_display_table_template' ) ) {
    function basel_sguide_display_table_template( $sguide_post, $size_tables ){
        ...
        if ( !basel_get_opt( 'size_guides' ) || $is_quick_view ) return;
        ?>
            ...
            <div class="sizeguide-btn-wrapp">
                <a class="basel-popup-with-content basel-sizeguide-btn" href="#basel_sizeguide"><?php esc_html_e( 'Size Guide', 'basel' ); ?></a>
            </div>
        <?php
    }
}
