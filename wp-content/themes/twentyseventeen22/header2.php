...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo esc_url(get_template_directory_uri('/'));?>/assets/css/style.css" media="all" charset="utf-8"/>
		        ...
		        <div class="collapse navbar-collapse" id="ci-navbar-collapse">
		            <ul class="nav navbar-nav pull-right">
		                <li class="nav-item"><a href="<?php echo esc_url(home_url('/')); ?>#home" class="nav-link">Home</a></li>
        						<li class="nav-item"><a href="<?php echo esc_url(home_url('/')); ?>#about" class="nav-link">About Us</a></li>
        						...
        						<li class="nav-item"><a href="<?php echo esc_url(home_url('/')); ?>#testimonial" class="nav-link">Testimonials</a></li>
