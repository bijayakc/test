							...
							<div class="col-lg-6 col-md-6">
								<aside>
									...
									<div class="content-footer">
										<span style="font-size: 16px;color: #fff;text-transform: capitalize;"><?php the_author(); ?></span>
										...
										<a href="<?php the_permalink(); ?>" class="btn btn-lg btn-color btn-margin-top">Read More</a>
									</div>
								</aside>
							</div>
	    				<?php 
